 ...
 * @author diego
 */
@WebServlet(name = "BorrarOrador", urlPatterns = {"/BuscaBorrarOrador"})
public class BuscaBorrarOradorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("borraorador.jsp").forward(request, response);
